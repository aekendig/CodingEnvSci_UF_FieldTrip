...
thanksgiving_pies <- read.csv("./data/thanksgiving-pies-2015.csv")
...
Often, we type data into a program like Excel. We have to then import it into R to work with it. Run the code below, which imports data on the types of pies people eat at Thanksgiving.
...
Try making a similar plot with "count" on the y-axis:
